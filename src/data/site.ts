	...
	zh: {
		...
		education: [
			...
			},
			{
				...
				advisor: undefined,
				details: 'GPA 3.77/4.00；本科优秀毕业论文；主修课程：数学分析、高等代数、算法分析与数据结构、数据科学等。',
			},
		],
	...
	en: {
		...
		education: [
			...
			},
			{
				...
				advisor: undefined,
				details: 'GPA 3.77/4.00; Outstanding Undergraduate Thesis; major coursework: Mathematical Analysis, Advanced Algebra, Algorithm Analysis and Data Structures, and Data Science.',
			},
		],
		...
		honors: [
			...
			'Finalist, Mathematical Contest in Modeling (2024)',
			...
			'National Second Prize, China Undergraduate Mathematical Contest in Modeling (2022)',
			'National Third Prize, Shenzhen Cup Mathematical Modeling Challenge (2022)',
		],
		skillsTitle: 'Skills',
		skills: [
