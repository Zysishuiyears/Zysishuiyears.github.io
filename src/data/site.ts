	...
	zh: {
		...
		education: [
			...
			},
			{
				...
				advisor: undefined,
				details: 'GPA 3.77/4.00（综合排名 3/133）；本科优秀毕业论文；主修课程：数学分析、高等代数、运筹学、算法分析与数据结构、数据科学、贝叶斯计算等。',
			},
		],
	...
	en: {
		...
		education: [
			...
			},
			{
				...
				advisor: undefined,
				details: 'GPA 3.77/4.00 (overall rank: 3/133); Outstanding Undergraduate Thesis; major coursework: Mathematical Analysis, Advanced Algebra, Operations Research, Algorithm Analysis and Data Structures, Data Science, and Bayesian Computing.',
			},
		],
