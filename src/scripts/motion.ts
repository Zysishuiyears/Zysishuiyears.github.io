...
if (!reduceMotion) {
	requestAnimationFrame(() => {
		...
		introTimeline
			.from('[data-header]', { y: -10, opacity: 0.98, duration: 0.28, ease: 'power1.out' }, 0.12)
			.from('[data-profile]', { x: -14, opacity: 0.98, duration: 0.48, ease: 'power3.out' }, 0.18)
			.from('[data-intro]', { y: 12, opacity: 0.98, duration: 0.56, ease: 'expo.out' }, 0.24);
